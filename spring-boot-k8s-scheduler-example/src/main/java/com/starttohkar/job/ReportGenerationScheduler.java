package com.starttohkar.job;

import com.starttohkar.service.NotificationService;
import com.starttohkar.service.ReportService;
...
public class ReportGenerationScheduler {
    ...
    Logger log = LoggerFactory.getLogger(ReportGenerationScheduler.class);
    @Autowired
